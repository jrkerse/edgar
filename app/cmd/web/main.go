...
import (
	...
	"edgar.avani.io/internal/database"
	"edgar.avani.io/internal/smtp"
	"edgar.avani.io/internal/version"
...
func run(logger *slog.Logger) error {
	...
	flag.StringVar(&cfg.cookie.secretKey, "cookie-secret-key", "az53kb25usxvv2q4scl3neo6ujz46tri", "secret key for cookie authentication/encryption")
	...
	flag.StringVar(&cfg.session.secretKey, "session-secret-key", "girviuedpbnc5o7rv3z7uka3j4ac5gkk", "secret key for session cookie authentication")
