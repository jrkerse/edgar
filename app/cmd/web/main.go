...
func run(logger *slog.Logger) error {
	...
	flag.StringVar(&cfg.cookie.secretKey, "cookie-secret-key", "sne2l2gg356lwutth3yap3daau2dqh5g", "secret key for cookie authentication/encryption")
	...
	flag.StringVar(&cfg.session.secretKey, "session-secret-key", "btfcud5iifqyzjsuzmyfecipjpbywllj", "secret key for session cookie authentication")
